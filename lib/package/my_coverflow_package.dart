...
class MyCoverFlowPackage extends StatefulWidget {
  ...
  @override
  _MyCoverFlowPackageState createState() => _MyCoverFlowPackageState();
}

class _MyCoverFlowPackageState extends State<MyCoverFlowPackage> {
